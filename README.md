...
- Registry: 29,240 molecules / static active 34
...
- `dist/automatic-safe-activation-v1/`: 현재 배포 Wheel과 release manifest
...
- 실제 원격 처방: `prototype_ready`, 9 ingredients, safety PASS
