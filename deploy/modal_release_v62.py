"""Authenticated V62 research deployment; keeps the existing app and web URL."""
import os
...
BUNDLE_SHA256='6896fdb87083df68325acb82e8912c774799f25d2077c03b0ad3d0cc8c886b5c'
if modal.is_local():
...
image=(modal.Image.debian_slim(python_version='3.11')
    ...
    .add_local_file(ROOT/'deploy/runtime_release_v62.py','/opt/perfumery/runtime_release_v62.py',copy=True)
    .run_commands(f'python /opt/perfumery/runtime_release_v62.py --check-installed {REMOTE_ROOT}')
