...
RELEASE_ID='v63-20260910'
WHEEL_REL='dist/latency-v63/candidate-01/wheel/perfumery_ai_core-1.4.0-py3-none-any.whl'
WHEEL_SHA256='136ab1c78238bc8a62a8ad11ba0b030dc411b3c098ac8ffa01a61696b9c8eefd'
PROFILE_SHA256='aff49eb757f31e19844cea94be99a91577d8a60055fb4b4740c66c6ae71ef686'
...
def collect(root=ROOT):
    ...
    if sha(path)!=PROFILE_SHA256:
        raise ValueError('the selected V63 profile changed; prepare a new release')
