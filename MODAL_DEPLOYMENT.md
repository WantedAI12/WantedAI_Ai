...
2026-09-17: 현재 배포는 **V91 백엔드 연동 개선판**입니다. 기존 URL·인증 방식·원료·가중치·300초 제한을 유지합니다. 실제 배포 이미지 26개 API 검사와 응답 15개의 Java DTO 파싱을 확인했습니다. [V91 변경·검증 기록](AI_BACKEND_ALIGNMENT_V91.md), [배포 원문 검증](output/backend-v91-deployed-20260917/verification.json)을 따릅니다. 이전 배포와 모델 실험 기록은 보존했습니다.

아래는 이전 V63 배포 기록입니다. V69 / Modal v17과 V80 / Modal v19는 이전 운영 버전이며, 현재 재배포 진입점은 `deploy/modal_release_v89.py`입니다.
